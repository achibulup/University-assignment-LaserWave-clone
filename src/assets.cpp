...
const AssetId SCORE_FONT ("SCORE-FONT");
...
void loadAssets(AssetManager &asset)
{
    ...
    asset.loadFont(SCORE_FONT, "assets/fonts/Cyberjunkies.ttf");
...
List<DrumNote> loadActionPattern()
{
    return {
      ...
      {PlayerAction::KICK, 0.35f},
      {PlayerAction::SHOOT, 0.3f},
      {PlayerAction::KICK, 1.05f},
      {PlayerAction::SHOOT, 0.3f},
      ...
      {PlayerAction::SHOOT, 0.3f},
      {PlayerAction::KICK, 0.6f},
      {PlayerAction::KICK, 0.18f},
      {PlayerAction::KICK, 0.18f},
      {PlayerAction::SHOOT, 0.3f},
      {PlayerAction::KICK, 0.5f},
      {PlayerAction::KICK, 0.35f},
      {PlayerAction::KICK, 0.18f},
      {PlayerAction::SHOOT, 0.35f},
      {PlayerAction::KICK, 0.7f},
      {PlayerAction::KICK, 0.35f},
      {PlayerAction::SHOOT, 0.3f},
      {PlayerAction::KICK, 1.05f},
      {PlayerAction::SHOOT, 0.3f},
